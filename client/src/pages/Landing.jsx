  ...
  return (
    <div>
                ...
                <div style={mockVideoRow}>
                  ...
                  <div
                    style={{
                      ...mockVideoTile,
                      background:
                        'linear-gradient(135deg,#EEEDFE,#E1F5EE)',
                    }}
                  >
                    You
                  </div>
        ...
        <div className="container">
          ...
          <div style={featureGrid}>
            <FeatureCard
              ...
              desc="Peer-to-peer video consultation built directly into every Visit Room, no third-party meeting link needed."
            />

            <FeatureCard
              icon="🔑"
              title="Shareable room codes"
              desc="Doctors generate a Visit Room and share a simple code — patients join in seconds."
            />

            <FeatureCard
              icon="📋"
              title="Structured vitals capture"
              desc="Temperature, blood pressure, sugar, SpO₂ and dosage stage recorded per visit, pre- and post-dosage."
            />

            <FeatureCard
              icon="📊"
              title="Interactive doctor dashboard"
              desc="Trends across patients and visits, visualized live as data comes in."
            />

            <FeatureCard
              icon="🧾"
              title="Patient intake profile"
              desc="Demographics and medical history captured directly from the patient at signup."
            />

            <FeatureCard
              icon="🧭"
              title="Visit history"
              desc="Every patient's full visit and vitals history, organized and reviewable at a glance."
            />
          </div>
        </div>
      </section>
      ...
      >
        ...
        >
          Ready to run a visit without the waiting room?
        </h2>
        ...
        <div
          className="flex gap-12 justify-center mt-32"
          style={{
      ...
      >
        <p className="text-muted text-sm">
          CareThread — Virtual Clinical Trial Visit Management
        </p>
      </footer>
    </div>
  );
...
const heroWrap = {
  ...
  background:
    'radial-gradient(1100px 500px at 15% -10%, #EEEDFE 0%, transparent 60%), radial-gradient(900px 500px at 100% 0%, #E1F5EE 0%, transparent 55%)',
};
...
const heroCardGlow = {
  ...
  inset: -20,
  background:
    'linear-gradient(135deg, rgba(91,79,191,0.25), rgba(15,110,86,0.2))',
  filter: 'blur(50px)',
  borderRadius: 30,
  zIndex: 0,
};
...
const mockVideoTile = {
  ...
  borderRadius: 12,
  background:
    'linear-gradient(135deg,#2b2740,#413a66)',
  color: 'white',
  display: 'flex',
  alignItems: 'flex-end',
  padding: 10,
