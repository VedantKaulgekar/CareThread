...
import ConcernForm from "../components/ConcernForm.jsx";
    ...
    return (
      <div>
        ...
        <div className="container" style={{ padding: 60, textAlign: "center" }}>
          ...
          <div>
            <Link to="/patient" className="btn btn-secondary mt-16">
              Back to workspaces
            </Link>
          </div>
        </div>
  ...
  return (
    <div>
      ...
      <div className="container" style={{ padding: "28px 32px 64px" }}>
          ...
          >
            <div className="flex justify-between items-center">
              ...
              <button
                ...
                onClick={() => navigate(`/room/${upcoming[0].room_code}`)}
              >
                Join visit
              </button>
            </div>
        ...
        <div style={{ marginBottom: 24 }}>
          <ConcernForm workspaceId={workspaceId} />
        </div>
        ...
        <div className="card" style={{ padding: 24 }}>
          ...
          <div className="flex-col gap-10">
            ...
            {[...upcoming, ...past].map((v) => (
              <VisitHistoryRow key={v.id} v={v} token={token} />
            ))}
          </div>
        </div>
      </div>
...
function VisitHistoryRow({ v, token }) {
    ...
    <div style={{ borderBottom: "1px solid var(--line-soft)" }}>
      ...
      {hasSummary && expanded && (
        <div style={summaryBox}>
          <div
            className="text-sm"
            style={{ fontWeight: 700, marginBottom: 4, color: "var(--purple)" }}
          >
            After-visit summary
          </div>
