...
const dropdownStyle = {
  ...
  background: 'var(--paper, #fff)', border: '1px solid var(--line-soft, #e5e7eb)',
  borderRadius: 10, boxShadow: 'var(--shadow-lg, 0 8px 24px rgba(0,0,0,0.12))',
...
const dropdownItemStyle = {
  ...
  color: 'inherit', textDecoration: 'none', background: 'none', border: 'none', cursor: 'pointer',
};
