 ...
 * open-weight models (Llama 3.3 70B by default) at very low latency.
 * API is OpenAI-compatible, so the official `groq-sdk` client mirrors
 * the OpenAI SDK shape almost exactly.
 *
